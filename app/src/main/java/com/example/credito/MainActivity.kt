...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val valorPrestamoEditText = findViewById<EditText>(R.id.editTextNumber2)
        val tasaInteresEditText = findViewById<EditText>(R.id.editTextNumberDecimal)
